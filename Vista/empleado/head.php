	...
	<section class="full-box cover dashboard-sideBar">
		<div class="full-box dashboard-sideBar-ct">
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				<li>
					<a href="index.php" id="colornegroboton">
						<i class="zmdi zmdi-view-dashboard zmdi-hc-fw"></i> Inicio
					</a>
				</li>
				<li>
					<a href="productos.php" class="btn-sideBar-SubMenu">
					<i class="zmdi zmdi-mall"></i> Vender Producto
					</a>
				</li>
				<li>
					<a href="misVentas.php" class="btn-sideBar-SubMenu">
						<i class="zmdi zmdi-shopping-cart"></i> Mis Ventas
					</a>
				</li>
				<li>
					<a href="pedidos.php" class="btn-sideBar-SubMenu">
						<i class="zmdi zmdi-case-check"></i> Recibir Pedido
					</a>
				</li>
				<li>
	...
	<section class="full-box dashboard-contentPage">
		...
		<nav class="full-box dashboard-Navbar">
			<ul class="full-box list-unstyled text-right">
				...
				<li>
					<a href="../../Manuales/manualEmpleado.pdf"  target="_blank" class="btn-modal-help">
